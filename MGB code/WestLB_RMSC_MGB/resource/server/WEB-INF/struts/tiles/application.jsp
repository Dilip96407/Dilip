...
<script type="text/javascript">
	...
	function startApplet(mandantCode) {	
		  window.open("<%=request.getContextPath()%>/startApplet.do?mandant="+mandantCode,'MGB','fullscreen=0,width=790,height=550,toolbar=0,location=0,directories=0,status=yes,menubar=0,scrollbars=yes,resizable=yes')
	}
</script>
