...
public class IBlpData extends Dispatch implements COMconstants
{
   public static final String clsid = "{F2303260-4969-11D1-B305-00805F815CBF}";
   ...
   public IBlpData(String clsidin) 
   {
      super(clsidin);
   }

   public IBlpData(int IDispatch) 
   {
      super(IDispatch);
   }

   public IBlpData(Object theObject) 
   {
      super(theObject);
   }

   public IBlpData(int canvasHWND, int nullval) 
   {
      super(clsid, canvasHWND);
   }

   public IBlpData(String clsidin, int canvasHWND, int nullval) 
   {
