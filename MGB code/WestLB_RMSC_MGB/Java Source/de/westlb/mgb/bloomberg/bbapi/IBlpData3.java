...
public class IBlpData3 extends Dispatch implements COMconstants
{
   public static final String clsid = "{54577140-C41E-11D5-BBE0-0002A51899EE}";
   ...
   public IBlpData3(String clsidin) 
   {
      super(clsidin);
   }

   public IBlpData3(int IDispatch) 
   {
      super(IDispatch);
   }

   public IBlpData3(Object theObject) 
   {
      super(theObject);
   }

   public IBlpData3(int canvasHWND, int nullval) 
   {
      super(clsid, canvasHWND);
   }

   public IBlpData3(String clsidin, int canvasHWND, int nullval) 
   {
