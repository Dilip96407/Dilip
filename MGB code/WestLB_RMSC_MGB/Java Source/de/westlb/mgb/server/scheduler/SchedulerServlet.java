package de.westlb.mgb.server.scheduler;
...
import de.westlb.mgb.model.definition.SchedulerPropertiesDef;
 ...
 */
public class SchedulerServlet extends HttpServlet implements SchedulerPropertiesDef {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8325449159974326380L;
    ...
    public void init() throws ServletException {
		...
		try {
			...
			String schedulerPropertiesName = getInitParameter(PARAM_SCHEDULER_PROPERTIES);
			log.debug("Param " + PARAM_SCHEDULER_PROPERTIES + " = " + schedulerPropertiesName);
			if (schedulerPropertiesName == null) {
				String msg = "Could not resolve init parameter " + PARAM_SCHEDULER_PROPERTIES;
				log.fatal(msg);
