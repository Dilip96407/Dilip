 ...
 */
public class DerivativeLookAndFeel extends LookAndFeel {
	/**
     * 
     */
    private static final long serialVersionUID = -1944854806542178042L;
    ...
    protected void initComponentDefaults(UIDefaults table) {
		...
		table.put("MandantName", "Derivative");
        table.put("MenuBar", getMenuBar());
        table.put("S3Bar", getS3Bar());   
		table.put("HompageImage", iconKatalog.getImage("MGB_HOMEPAGE_DERIVATIVE"));
		table.put("TradeOverviewView", "de.westlb.mgb.client.mask.view.derivative.DerivativeTradeOverviewView");    
    ...
    private S3Bar getS3Bar() {
        return new S3Bar("FolderBarResource", "", new Object[][] {
            ...
            { ApplicationDefinitions.go_report, FolderBar.FOLDERMENU }, 
                ...
                { ApplicationDefinitions.go_statistic_trade_category_derivative, FolderBar.FOLDERITEM }, 
                { ApplicationDefinitions.go_statistic_instrument, FolderBar.FOLDERITEM }, 
