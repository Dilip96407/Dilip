 ...
 */
public class BondLookAndFeel extends LookAndFeel {
	/**
     * 
     */
    private static final long serialVersionUID = -6121192248349785994L;
    ...
    protected void initComponentDefaults(UIDefaults table) {
		...
		table.put("MandantName", "Bond");
        table.put("MenuBar", getMenuBar());
        table.put("S3Bar", getS3Bar());   
		table.put("HompageImage", iconKatalog.getImage("MGB_HOMEPAGE_BOND"));
		table.put("TradeOverviewView", "de.westlb.mgb.client.mask.view.bond.BondTradeOverviewView");    
    ...
    private S3Bar getS3Bar() {
        return new S3Bar("FolderBarResource", "", new Object[][] {
            ...
            { ApplicationDefinitions.go_report, FolderBar.FOLDERMENU }, 
				...
				{ ApplicationDefinitions.go_statistic_trade_category_bond, FolderBar.FOLDERITEM }, 
