 ...
 */
public class EquityLookAndFeel extends LookAndFeel {
	/**
     * 
     */
    private static final long serialVersionUID = 6788673384222860325L;
    ...
    protected void initComponentDefaults(UIDefaults table) {
		...
		table.put("MandantName", "Equity");
        table.put("MenuBar", getMenuBar());
        table.put("S3Bar", getS3Bar());   
		table.put("HompageImage", iconKatalog.getImage("MGB_HOMEPAGE_EQUITY"));
		table.put("TradeOverviewView", "de.westlb.mgb.client.mask.view.equity.EquityTradeOverviewView");    
		table.put("RepoTradeOverviewView", "de.westlb.mgb.client.mask.view.repo.RepoTradeOverviewView"); 
    ...
    private S3Bar getS3Bar() {
        return new S3Bar("FolderBarResource", "", new Object[][] {
            { ApplicationDefinitions.go_analyse, FolderBar.FOLDERMENU }, 
				{ ApplicationDefinitions.go_analyse_euwax_auto, FolderBar.FOLDERITEM }, 
	            ...
	            { ApplicationDefinitions.go_analyse_sample, FolderBar.FOLDERITEM }, 
            ...
            { ApplicationDefinitions.go_report, FolderBar.FOLDERMENU }, 
                ...
                { ApplicationDefinitions.go_statistic_trade_category_equity, FolderBar.FOLDERITEM }, 
                { ApplicationDefinitions.go_statistic_trade_type_equity, FolderBar.FOLDERITEM }, 
            ...
            { ApplicationDefinitions.go_admin, FolderBar.FOLDERMENU },             
	            ...
	            { ApplicationDefinitions.go_admin_exchange, FolderBar.FOLDERITEM },             
	            { ApplicationDefinitions.go_admin_price_check_category, FolderBar.FOLDERITEM },             
	            { ApplicationDefinitions.go_admin_addon, FolderBar.FOLDERITEM },             
    ...
    private MenuBar getMenuBar() {
        return new MenuBar(
            ...
            ApplicationDefinitions.edit, 
            	...
            	ApplicationDefinitions.edit_new_addon,
            	ApplicationDefinitions.edit_new_employee,
            	ApplicationDefinitions.edit_new_exchange,
