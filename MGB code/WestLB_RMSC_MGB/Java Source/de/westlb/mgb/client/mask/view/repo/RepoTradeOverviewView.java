 ...
 */
public class RepoTradeOverviewView extends AbstractView {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8875723009747099656L;
	...
	/**
	 * Constructor for RepoTradeOverviewView.
	 */
	public RepoTradeOverviewView() {
		try {
			initComponents();
			initLayout();
			initLabels();
	 ...
	 * @param model
	 */
	public RepoTradeOverviewView(Model model) {
		super(model);
	}
	...
	private void initLayout() {		
		...
		add(tpCheckResult,		new GridBagConstraints2(1, 0, 1, 1, 1.0, 1.0, NWEST, BOTH, insets4008, 0, 0));

		// Line 1
		add(tpRepoCheckData,	new GridBagConstraints2(0, 1, 2, 1, 1.0, 1.0, NWEST, BOTH, insets4888, 0, 0));
