 ...
 */
public class BondTradeOverviewView extends AbstractView {
    /**
     * 
     */
    private static final long serialVersionUID = -8691101859150790370L;
    ...
    private BondTradeOvTradePanelView pTrade = new BondTradeOvTradePanelView();
    private BondTradeOvMarketDataPanelView pMarketData = new BondTradeOvMarketDataPanelView();
    private TradeOvResultPanelView pCheckResult = new TradeOvResultPanelView();

    /**
     * Constructor for BondTradeOverviewView.
     */
    public BondTradeOverviewView() {
        try {
            initComponents();
            initLayoutInitial();
            initLabels();
     ...
     * @param model
     */
    public BondTradeOverviewView(Model model) {
        super(model);
    }
    ...
    private void initLayoutInitial() {
        ...
        add(tpCheckResult,
           	new GridBagConstraints2(0, 2, 1, 1, 1.0, 1.0, NWEST, HORIZ, insets4808, 0, 0));
