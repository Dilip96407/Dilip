 ...
 */
public class NewTraderInfoCtrl extends Ctrl {
    ...
    public void actionRequested(UserEvent ue) {
     	...
     	if (ue.getAction() == NewTraderInfoDialog.EV_EDIT_TRADER) {
	        boolean success = showDialog(ContentID.MGB_SEARCH_NEW_EMPLOYEE, ue.getParameters(),view);
	        if (success) {
