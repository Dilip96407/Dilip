 ...
 */
public class MmkDoubleTradeOverviewView extends AbstractView {
	/**
	 * 
	 */
	...
	private MmkDoubleTradeOvTradePanelView pTrade		= new MmkDoubleTradeOvTradePanelView();
	 ...
	 */
	public MmkDoubleTradeOverviewView() {
		try {
			initComponents();
			initLayoutInitial();
			initLabels();
	 ...
	 * @param model
	 */
	public MmkDoubleTradeOverviewView(Model model) {
		super(model);
	}
