 ...
 */
public class PriceDeviationStatisticListView extends AbstractView {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3106796256136367879L;
	 ...
	 */
	public PriceDeviationStatisticListView() {
		try {
			initComponents();
			initLayout();
			initLabels();
	 ...
	 */
	public PriceDeviationStatisticListView(Model model) {
		this();
		setModel(model);
	}
    ...
    */
    private void fillView() {
        if (getPriceDeviationStatisticListModel() == null) {
            return;
        }
	 ...
	 * 
	 */
	public PriceDeviationStatisticListModel getPriceDeviationStatisticListModel() {
		return getModel() instanceof PriceDeviationStatisticListModel ? (PriceDeviationStatisticListModel)getModel() : null;
	}
    ...
    public void setModel(Model newModel) {
	    if (!(newModel instanceof PriceDeviationStatisticListModel)) {
	        throw new IllegalArgumentException("Model not instance of PriceDeviationStatisticListModel");
	    }
