 ...
 */
public class PriceCheckCategoryListCtrl extends Ctrl {
     @Override
    public void actionRequested(UserEvent ue) {
     	switch (ue.getAction()) {
     		case AddonListView.EV_NEW:
				fireContentRequestet(new ContentRequestEvent(this, ContentID.MGB_PRICE_CHECK_CATEGORY_EDIT, ue.getParameters()));
