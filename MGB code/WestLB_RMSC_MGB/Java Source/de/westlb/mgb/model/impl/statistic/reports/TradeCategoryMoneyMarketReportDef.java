 ...
 *
 */
public class TradeCategoryMoneyMarketReportDef extends AbstractReportDef implements ReportDef {
	private final static String[] KEY_COLUMN_NAMES = new String[] {
		"trade.sourceSystemInstrument",
	};
    ...
    public String getEntityName() {
    	return AbstractMoneyMarketImpl.class.getName();
    }
