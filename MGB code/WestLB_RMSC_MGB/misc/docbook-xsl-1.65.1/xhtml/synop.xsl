...
<xsl:template match="funcdef/function" mode="kr-nontabular">
  <xsl:choose>
    <xsl:when test="$funcsynopsis.decoration != 0">
      <b xmlns="http://www.w3.org/1999/xhtml" class="fsfunc"><xsl:apply-templates mode="kr-nontabular"/></b>
    </xsl:when>
    <xsl:otherwise>
      <xsl:apply-templates mode="kr-nontabular"/>
    </xsl:otherwise>
...
<xsl:template match="paramdef" mode="kr-funcsynopsis-mode">
  <xsl:if test="preceding-sibling::paramdef"><br xmlns="http://www.w3.org/1999/xhtml"/></xsl:if>
...
<xsl:template match="funcprototype" mode="kr-tabular">
  <table xmlns="http://www.w3.org/1999/xhtml" border="0" summary="Function synopsis" cellspacing="0" cellpadding="0" style="padding-bottom: 1em">
    <tr>
      <td>
  ...
  <xsl:if test="paramdef">
    <table xmlns="http://www.w3.org/1999/xhtml" border="0" summary="Function argument synopsis" cellspacing="0" cellpadding="0">
...
<xsl:template match="funcdef/function" mode="ansi-nontabular">
  <xsl:choose>
    <xsl:when test="$funcsynopsis.decoration != 0">
      <b xmlns="http://www.w3.org/1999/xhtml" class="fsfunc"><xsl:apply-templates mode="ansi-nontabular"/></b>
    </xsl:when>
    <xsl:otherwise>
      <xsl:apply-templates mode="ansi-nontabular"/>
    </xsl:otherwise>
...
<xsl:template match="void" mode="ansi-nontabular">
  <code xmlns="http://www.w3.org/1999/xhtml">void)</code>
  <xsl:text>;</xsl:text>
</xsl:template>
...
<xsl:template match="funcprototype" mode="ansi-tabular">
  <table xmlns="http://www.w3.org/1999/xhtml" border="0" summary="Function synopsis" cellspacing="0" cellpadding="0">
    <xsl:if test="following-sibling::funcprototype">
      <xsl:attribute name="style">padding-bottom: 1em</xsl:attribute>
    </xsl:if>
    <tr>
